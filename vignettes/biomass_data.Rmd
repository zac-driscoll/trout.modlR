...
Two or models can be passed to make_bmsPlots() to compare biomass data. Two
model types can be produced. These are "cumulative" and "multiple".

### Compare Models

When two to three models are passed to make_bmsPlots() and type is set to 
...
make_bmsPlots(dat1 = trout1, plotly = TRUE)
...
make_bmsPlots(dat1 = trout1, title = "Trout are cool!")
...
make_bmsPlots(dat1 = trout1, ymax = 1000)
